...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) pb.Response {
	...
	} else if function == "chargeToken" {
		return s.chargeToken(APIstub, args)
...
func (s *SmartContract) getUser(APIstub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	buffer.WriteString(", \"RepairAthority\":")
	buffer.WriteString("\"")
	buffer.WriteString(wallet.RepairAthority)
	buffer.WriteString("\"")
...
func (s *SmartContract) chargeToken(APIstub shim.ChaincodeStubInterface, args []string) pb.Response {
	
	var beforeToken int
	var chargeTokenNum int
	var err error
	...
	beforeToken, _ = strconv.Atoi(user.Token) // 기존 토큰 값 가져옴
	chargeTokenNum, _ = strconv.Atoi(string(args[1])) // 충전할 토큰 값


	user.Token = strconv.Itoa(beforeToken + chargeTokenNum)
	updatedUserAsBytes, _ := json.Marshal(user)
	APIstub.PutState(args[0], updatedUserAsBytes)
...
func (s *SmartContract) getCar(APIstub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	buffer.WriteString("{\"Thumbnail\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Thumbnail)
	buffer.WriteString("\"")

	buffer.WriteString(", \"Title\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Title)
	buffer.WriteString("\"")
	
	buffer.WriteString(", \"Country\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Country)
	buffer.WriteString("\"")

	buffer.WriteString(", \"CarType\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.CarType)
	buffer.WriteString("\"")

	buffer.WriteString(", \"Manufacturer\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Manufacturer)
	buffer.WriteString("\"")
	...
	buffer.WriteString(", \"ModelGen\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.ModelGen)
	buffer.WriteString("\"")

	buffer.WriteString(", \"ModelDetail\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.ModelDetail)
	buffer.WriteString("\"")

	buffer.WriteString(", \"Year\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Year)
	buffer.WriteString("\"")

	buffer.WriteString(", \"YearDetail\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.YearDetail)
	buffer.WriteString("\"")

	buffer.WriteString(", \"DistanceDriven\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.DistanceDriven)
	buffer.WriteString("\"")
	...
	buffer.WriteString(", \"SellerCategory\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.SellerCategory)
	buffer.WriteString("\"")

	buffer.WriteString(", \"Color\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Color)
	buffer.WriteString("\"")
	
	buffer.WriteString(", \"Fuel\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Fuel)
	buffer.WriteString("\"")

	buffer.WriteString(", \"Gearbox\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Gearbox)
	buffer.WriteString("\"")
	
	buffer.WriteString(", \"Option\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Option)
	buffer.WriteString("\"")

	buffer.WriteString(", \"Accident\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Accident)
	buffer.WriteString("\"")
	
	buffer.WriteString(", \"Seaters\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Seaters)
	buffer.WriteString("\"")

	buffer.WriteString(", \"Region\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Region)
	buffer.WriteString("\"")
	
	buffer.WriteString(", \"Badge\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Badge)
	buffer.WriteString("\"")

	buffer.WriteString(", \"InsuranceHistory\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.InsuranceHistory)
	buffer.WriteString("\"")
	
	buffer.WriteString(", \"Shipping\":")
	buffer.WriteString("\"")
	buffer.WriteString(car.Shipping)
	buffer.WriteString("\"")
	...
	buffer.WriteString("\"")
	buffer.WriteString(car.SellerName)
	buffer.WriteString("\"")
...
*/
func (s *SmartContract) createUser(APIstub shim.ChaincodeStubInterface, args []string) pb.Response {
